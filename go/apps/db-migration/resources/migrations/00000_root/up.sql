-- Copied from https://raw.githubusercontent.com/2ndQuadrant/audit-trigger/master/audit.sql
...
CREATE OR REPLACE FUNCTION audit.audit_table(target_table regclass, audit_rows boolean,
...
CREATE OR REPLACE FUNCTION audit.audit_table(target_table regclass, audit_rows boolean,
                                             audit_query_text boolean) RETURNS void AS
$body$
...
CREATE OR REPLACE VIEW audit.audited_table_list AS
...
COMMENT ON VIEW audit.audited_table_list IS $body$
