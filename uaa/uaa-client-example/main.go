...
func main() {
	...
	provider, err := oidc.NewProvider(ctx, "http://127.0.0.1:9000/")
	if err != nil {
		log.Fatal(err)
	}
	...
	http.HandleFunc("/example/auth/callback", func(w http.ResponseWriter, r *http.Request) {
	...
	log.Printf("listening on http://%s/", "127.0.0.1:9010")
